...
extension CAJoystickControl {
    ...
    private func thumbPositionForValue(value: CAJoystickVector) -> CGPoint {
    ...
    private func valueForThumbPosition(position: CGPoint) -> CAJoystickVector {
        ...
        return CAJoystickVector(dx: invert(position.x, CGRectGetWidth(bounds)), dy: -invert(position.y, CGRectGetHeight(bounds)))
    }
